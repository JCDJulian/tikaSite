$(document).ready(function(){
	...
	$("div.about").css({
		...
		$('#text').css({
			...
			$("#text").append("<p>I'm an undergraduate at Arizona State University studying Biochemistry. I'm interested in biology and chemical research as it applies to the human body and medical research.</p>");
	...
	$("div.research").css({
		...
		$("div.research div").append("<p>I work under Dr. John Chaput in the Evolutionary Medicine and Informatics Research Center. Currently, I'm working on optimizing the synthesis of the unnatural RNA analog, TNA. My research focuses on adenine and what conditions and environments are preferable for its coupling with threose, the deoxyribose analog. The goal of this research is to further understand RNA's role within life's origins and how TNA may have been a predecessor to RNA. This research will give scientists insight into the evolution of genetic mutations.</p>")
